...
- 🌐 **Project website (GitHub Pages):** <https://merwanroudane.github.io/pybayescointur/>
- 📓 **Tutorial notebook:** [`notebooks/pybayescointur_tutorial.ipynb`](notebooks/pybayescointur_tutorial.ipynb)
  (theory + all four methods + tables + light-themed plots, fully executed).
- 🖼️ **Extracted figures &amp; tables:** every plot (`docs/images/`) and table
  (`docs/tables/`, both `.html` and `.csv`) is regenerated by
  [`docs/generate_assets.py`](docs/generate_assets.py).
